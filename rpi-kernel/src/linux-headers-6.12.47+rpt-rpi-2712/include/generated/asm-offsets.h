...
#define THREAD_SCTLR_USER 8368 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 8264 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 8344 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 8360 /* offsetof(struct task_struct, thread.mte_ctrl) */
